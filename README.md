...
Proyecto desarrollado en R Markdown como parte de mi formación en ciencia de datos, enfocado en el análisis exploratorio de bases de datos públicas sobre incidencia delictiva en la República Mexicana.
